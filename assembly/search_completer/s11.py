...
from PySide2.QtWidgets import QApplication, QGridLayout, QLabel, QComboBox, QCompleter, QLineEdit, QDialog, QPushButton
...
class ManageSubmit(QDialog):
    ...
    def initUI(self):
        # 按钮 button = QPushButton("clicked me")
        ...
        leftLayout.addWidget(button, 0, 2)
